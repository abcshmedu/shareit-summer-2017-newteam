...
public final class ResponseBuilder {
    ...
    /**
     * Creates a new ResponseBuilder with the given status code and HTTP status message.
     * @param code The status code of the HTTP response.
     * @param status The HTTP status message corresponding to the code
     * @return A new ResponseBuilder with the given code and status.
     */
    ...
    /**
     * Adds an object to the response body. The object should be compatible with Jackson.
     * @param toAdd The object to add.s
